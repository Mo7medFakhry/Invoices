        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . $page = 'Invoice_UnPaid') }}">الفواتبر غير المدفوعة</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . $page = 'Invoice_Partial') }}">الفواتبر المدفوعة جزئيا</a>
                    </li>
                </ul>
            </li>
